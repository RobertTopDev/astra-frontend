...
type TStakingLpTokenClaimAstraProps = {
  ...
  eligibleWithdrawableNFTId: string
  apyInfo: {
...
const StakingLpTokenClaimLpToken = ({
  isLoading,
...
}: TStakingLpTokenClaimAstraProps) => {
  // WEB3 CONFIG
    ...
    if (cooldownStatus() === 0) {
      ...
      return (
        ...
        >
          <Button
            variant="astra-blue"
            disabled={!withdrawAstra || !withdrawAstraWithStaked}
            isLoading={isLoading}
            className="my-2"
          >
            UNSTAKE
  ...
  return (
    <div className="col-span-6 flex flex-col gap-6 relative">
      ...
      <div className="flex flex-col text-xs">
        ...
        <div className="flex justify-between">
          <div>NFT ID&apos;s eligible to withdraw</div>
          <div className="font-medium">
            <AstraLoading isLoading={isLoading}>
              {eligibleWithdrawableNFTId}
            </AstraLoading>
...
export { StakingLpTokenClaimLpToken }
