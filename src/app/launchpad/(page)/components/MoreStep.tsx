  ...
  return (
    <div className="flex flex-col items-stretch py-8">
      ...
      <div className="w-full grid grid-cols-12 lg:gap-16 gap-y-32 mt-20">
        <AstraCard
          className="lg:col-span-4 w-full col-span-full  min-w-0 bg-[#B2C4E833] border-none"
        ...
        <AstraCard
          className="lg:col-span-4 col-span-full w-full min-w-0 bg-[#B2C4E833] border-none"
