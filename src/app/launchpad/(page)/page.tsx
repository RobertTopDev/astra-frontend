...
import MoreStep from './components/MoreStep'
import AstraToday from './components/AstraToday'

export default function Launchpad() {
  if (process.env.NODE_ENV === 'development') {
    return (
      <div className="container max-w-full xl:max-w-[1200px] 2xl:max-w-[1400px]">
    ...
    return (
      <Image
        src="/images/launchpad/launching-soon.jpg"
        width={1400}
        height={1000}
        className="w-full"
        alt="launching soon"
