export const vestingAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_keeperInterval', type: 'uint256' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newKeeperInterval', type: 'uint256' },
    ],
    name: 'setNewKeeperInterval',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_newUpKeepTime', type: 'uint256' },
    ],
    name: 'setNewUpKeepTime',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
