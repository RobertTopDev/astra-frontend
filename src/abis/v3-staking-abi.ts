export const v3StakingAbi = [
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_pid', type: 'uint256' },
      {
        internalType: 'enum LmPoolV3Mock.RewardType',
        name: '_type',
        type: 'uint8',
      },
  ...
  {
    inputs: [
      { internalType: 'address', name: '_astr', type: 'address' },
      { internalType: 'address', name: '_devaddr', type: 'address' },
      { internalType: 'uint256', name: '_ASTRPerBlock', type: 'uint256' },
  ...
  {
    inputs: [{ internalType: 'address', name: '_chefaddr', type: 'address' }],
    name: 'setChefAddress',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'preBlockReward', type: 'uint256' },
      {
        internalType: 'uint256',
