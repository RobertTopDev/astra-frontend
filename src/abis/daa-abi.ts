export const DAAAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_rebalanceTime', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'USDTdeposit', type: 'uint256' },
      { internalType: 'uint256', name: 'Itokens', type: 'uint256' },
      { internalType: 'bool', name: 'active', type: 'bool' },
    ],
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_poolIndex', type: 'uint256' },
      { internalType: 'bool', name: 'stakeEarlyFees', type: 'bool' },
      { internalType: 'bool', name: 'stakePremium', type: 'bool' },
